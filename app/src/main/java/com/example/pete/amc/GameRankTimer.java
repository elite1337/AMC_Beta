...
public class GameRankTimer extends View {
    ...
    public GameRankTimer(Context context) {
        this(context, null);
    }

    public GameRankTimer(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GameRankTimer(Context context, AttributeSet attrs, int defStyleAttr) {
